...
//		}
	...
	private void sendUserAlert() {
		...
		switch (mustered){
			case 1: message = "Don't forget to Muster !!"; break;
			case 2: message = "Unable to check muster status.  Please verify user info";
					break;
			default: message = "Muster status unknown"; break;
		}
