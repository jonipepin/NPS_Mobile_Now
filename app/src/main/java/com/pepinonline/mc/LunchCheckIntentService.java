	...
	private void saveSpecial() {
		if (lunchSpecial != null) {
			try {
				...
				formattedSpecial = formattedSpecial.replaceAll("(CAFÉ DEL MONTE|EL PRADO DINING ROOM)", 
						"<font color=\"#00CCFF\"><b>$1:</b></font>");
				
				formattedSpecial = formattedSpecial.replaceAll("(Sides|Main Entrée Choices|Side Choices|Soup of the Day)", 
